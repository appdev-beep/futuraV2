...
--
-- Current Database: `futura`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `futura` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`developer1`@`localhost`*/ /*!50003 TRIGGER `trg_cl_approvals_bi_headerid_from_clid` BEFORE INSERT ON `cl_approvals` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`developer1`@`localhost`*/ /*!50003 TRIGGER `trg_cl_approvals_bu_headerid_from_clid` BEFORE UPDATE ON `cl_approvals` FOR EACH ROW BEGIN
  IF NEW.cl_header_id IS NULL AND NEW.cl_id IS NOT NULL THEN
    SET NEW.cl_header_id = NEW.cl_id;
  END IF;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`developer1`@`localhost`*/ /*!50003 TRIGGER `trg_cl_headers_bi_manager_from_supervisor` BEFORE INSERT ON `cl_headers` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`developer1`@`localhost`*/ /*!50003 TRIGGER `trg_cl_headers_bu_manager_from_supervisor` BEFORE UPDATE ON `cl_headers` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`developer1`@`localhost`*/ /*!50003 TRIGGER `trg_cl_items_bi_clid_from_header` BEFORE INSERT ON `cl_items` FOR EACH ROW BEGIN
  IF NEW.cl_id IS NULL AND NEW.cl_header_id IS NOT NULL THEN
    SET NEW.cl_id = NEW.cl_header_id;
  END IF;
END */;;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`developer1`@`localhost`*/ /*!50003 TRIGGER `trg_cl_items_bu_clid_from_header` BEFORE UPDATE ON `cl_items` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`developer1`@`localhost`*/ /*!50003 TRIGGER `trg_idp_items_bi_sync_header_ids` BEFORE INSERT ON `idp_items` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`developer1`@`localhost`*/ /*!50003 TRIGGER `trg_idp_items_bu_sync_header_ids` BEFORE UPDATE ON `idp_items` FOR EACH ROW BEGIN
  IF NEW.idp_header_id IS NULL AND NEW.header_id IS NOT NULL THEN
    SET NEW.idp_header_id = NEW.header_id;
  END IF;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`developer1`@`localhost`*/ /*!50003 TRIGGER `positions_bi_sync_compat` BEFORE INSERT ON `positions` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`developer1`@`localhost`*/ /*!50003 TRIGGER `positions_bu_sync_compat` BEFORE UPDATE ON `positions` FOR EACH ROW BEGIN
  IF NEW.title IS NULL OR NEW.title = '' THEN
    SET NEW.title = NEW.name;
  END IF;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`developer1`@`localhost`*/ /*!50003 TRIGGER `users_bi_sync_compat` BEFORE INSERT ON `users` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`developer1`@`localhost`*/ /*!50003 TRIGGER `users_bu_sync_compat` BEFORE UPDATE ON `users` FOR EACH ROW BEGIN
...
-- Dump completed on 2026-01-08 22:02:22
